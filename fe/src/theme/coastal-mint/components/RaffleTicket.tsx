...
export function RaffleTicket({
  ...
  return (
    <article className={cn('ticket isolate overflow-hidden px-8 py-6 relative', className)}>
      ...
      <div className="ticket-body mt-6 grid gap-6 rounded-[20px] border border-border/50 px-6 py-5 lg:grid-cols-[1.1fr_1fr] relative z-10">
        <div className="space-y-3">
          <div className="flex items-center gap-2">
            <img src="/iso/coins.png" alt="" className="w-4 h-4 object-contain opacity-70" />
        ...
        <div className="space-y-3">
          <div className="flex items-center gap-2">
            <img src="/iso/chest.png" alt="" className="w-4 h-4 object-contain opacity-70" />
            <p className="text-xs font-semibold uppercase tracking-[0.35em] text-muted-foreground">
              Prize Claims
            </p>
          </div>
